...
// 获取部门名称
var apartment=""
if (localStorage.getItem("DEPT_NAME")) {
  apartment = DEPT_NAME;
}
...
function drawchart2(age, agedata) {
  console.log(document.getElementById("chart2"));
...
function getMessageyw(yearq) {
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      function decyw() {
        console.log(result)
        if (result.deptOPERATORYW&&result.deptOPERATORYW.length!=0) {
          uv1 = parseInt(result.deptOPERATORYW[0].U_NUM)
          mv1 = parseInt(result.deptOPERATORYW[0].M_NUM)
          tv1 = parseInt(result.deptOPERATORYW[0].T_NUM)
      ...
      function chart2yw() {
        ...
        if (result.quotaDeptAGEYW&&result.quotaDeptAGEYW.length!=0) {
          var age1 = [];
          var agedata1 = [];
          var sum1 = 0;
          var avg1 = 0;
      ...
      function chart3yw() {
        ...
        $("#chart3r").hide()
          ...
          if (result.quotaDeptTypeYW&&result.quotaDeptTypeYW.length!=0) {
      ...
      function chart4yw() {
        ...
        if (result.quotaDeptStarYW&&result.quotaDeptStarYW.length!=0) {
          for (var i = 0; i < result.quotaDeptStarYW.length; i++) {
            if (result.quotaDeptStarYW[i].USER_LEVEL == "1") {
              s1[1] = parseFloat(result.quotaDeptStarYW[i].U_NUM)
            }
            if (result.quotaDeptStarYW[i].USER_LEVEL == "2") {
              s2[1] = parseFloat(result.quotaDeptStarYW[i].U_NUM)
            }
            if (result.quotaDeptStarYW[i].USER_LEVEL == "3") {
              s3[1] = parseFloat(result.quotaDeptStarYW[i].U_NUM)
            }
            if (result.quotaDeptStarYW[i].USER_LEVEL == "4") {
              s4[1] = parseFloat(result.quotaDeptStarYW[i].U_NUM)
            }
            if (result.quotaDeptStarYW[i].USER_LEVEL == "5") {
              s5[1] = parseFloat(result.quotaDeptStarYW[i].U_NUM)
            }
            if (result.quotaDeptStarYW[i].USER_LEVEL == "NOT_RATING") {
              s6[1] = parseFloat(result.quotaDeptStarYW[i].U_NUM)
            }
          }
      ...
      function table2yw() {
        ...
        for (var i = 0; i < result.deptNPSYW.length; i++) {
          table2.push({
            ...
            user: parseInt(result.deptNPSYW[i].U_NUM),
      ...
      function table3yw() {
        ...
        for (var i = 0; i < result.deptProYW.length; i++) {
          table3.push({
            ...
            user: parseInt(result.deptProYW[i].U_NUM),
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      function deckd() {
        ...
        if (result.deptOPERATORKD&&result.deptOPERATORKD.length!=0) {

          uv2 = parseInt(result.deptOPERATORKD[0].U_NUM)
          mv2 = parseInt(result.deptOPERATORKD[0].M_NUM)
          tv2 = parseInt(result.deptOPERATORKD[0].T_NUM)
      ...
      // chart2
        function chart2kd() {
            ...
            if (result.quotaDeptAGEKD&&result.quotaDeptAGEKD.length!=0) {
                var age2 = [];
                var agedata2 = [];
                var sum2 = 0;
                var avg2 = 0;
      ...
      function chart3kd() {
        ...
        if (result.quotaDeptSexKD&&result.quotaDeptSexKD.length!=0) {
          for (var i = 0; i < result.quotaDeptSexKD.length; i++) {
            ...
            // }
              if(result.quotaDeptSexKD[i].SEX == "女") {
                  girl[0] = result.quotaDeptSexKD[i].U_NUM;
                  // girl[1]=0;
                  // girl[2]=0;
              }
              if(result.quotaDeptSexKD[i].SEX == "男") {
                  boy[0] = result.quotaDeptSexKD[i].U_NUM;
                  // boy[1]=0;
                  // boy[2]=0;
              }
          }
        ...
        if (result.allDeptTypeKD&&result.allDeptTypeKD.length!=0) {
          for (var i = 0; i < result.allDeptTypeKD.length; i++) {
            if (result.allDeptTypeKD[i].USER_TYPE == "FTTH") {
              skd1[1] = parseFloat(result.allDeptTypeKD[i].KD_NUM_PERCENT)
            }
            if (result.allDeptTypeKD[i].USER_TYPE == "LAN") {
              skd2[1] = parseFloat(result.allDeptTypeKD[i].KD_NUM_PERCENT)
            }
            if (result.allDeptTypeKD[i].USER_TYPE == "XDSL") {
              skd3[1] = parseFloat(result.allDeptTypeKD[i].KD_NUM_PERCENT)
            }
          ...
          for (var i = 0; i < result.quotaDeptTypeKD.length; i++) {
            if (result.quotaDeptTypeKD[i].USER_TYPE == "FTTH且安装IPTV") {
              skd1[0] = parseFloat(result.quotaDeptTypeKD[i].COUNT)
            }
            if (result.quotaDeptTypeKD[i].USER_TYPE == "FTTH且未安装IPTV") {
              skd1[0] += parseFloat(result.quotaDeptTypeKD[i].COUNT)
            }
            if (result.quotaDeptTypeKD[i].USER_TYPE == "LAN") {
              skd2[0] = parseFloat(result.quotaDeptTypeKD[i].COUNT)
            }
            if (result.quotaDeptTypeKD[i].USER_TYPE == "XDSL") {
              skd3[0] = parseFloat(result.quotaDeptTypeKD[i].COUNT)
            }


          }
          var sum = skd1[0] + skd2[0] + skd3[0]
          skd1[0] = parseFloat(skd1[0] / sum * 100).toFixed(2)
          skd2[0] = parseFloat(skd2[0] / sum * 100).toFixed(2)
          skd3[0] = parseFloat(skd3[0] / sum * 100).toFixed(2)
      ...
      /* ***** fivebox start ***** */
      function fiveboxkd() {
        console.log("fiveboxkd")
        console.log(result.pieKDDept[0].YEAR_NPS)
        ...
        var finish = result.pieKDDept[0].YEAR_FINISH * 100;
        if (finish > 100) {
          finish = 100
        }
        if (finish < 0) {
      ...
      function table2kd() {
        ...
        for (var i = 0; i < result.deptNPSKD.length; i++) {
          table2.push({
            ...
            user: parseInt(result.deptNPSKD[i].U_NUM),
      ...
      function table3kd() {
        ...
        for (var i = 0; i < result.deptProKD.length; i++) {
          table3.push({
            ...
            user: parseInt(result.deptProKD[i].U_NUM),
